...
%><div id="like-dislike-buttons">
  <button class="btn btn-secondary mr-1" href="/config?id=<%=profile.getId()%>" id="editProfile-btn" role="button"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></i> </button>
</div>
<%
}
